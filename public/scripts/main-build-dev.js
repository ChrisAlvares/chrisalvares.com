...
define("../components/requirejs/require.js", function(){});
...
define('data/genericdata',['jquery'], function($) 
{
...
define('views/financegraph',['jquery', 'highcharts', 'jqueryui'], function($) {
...
define('views/githubgraph',['jquery'], function($) {
...
define('views/weightgraph',['jquery', 'highcharts', 'jqueryui'], function($) {
...
define('views/productivitygraph',['jquery', 'underscore'], function($, _) {
...
define('views/energygraph',['jquery', 'highcharts', 'jqueryui'], function($) {
...
define('views/caloriegraph',['jquery'], function($) {
